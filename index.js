...
socket.on('newTrial', handleNewTrial);
...
function paintGame(state) {
  ...
  if (state.is_bonus_round == true) {
    ...
    ctx1.fillRect(0, 0, 612, 400);
    var charities_image = new Image();
    charities_image.src = "images/charities.png";
    ctx1.drawImage(charities_image, 0, 0);
