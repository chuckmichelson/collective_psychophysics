...
function paintGame(state) {
  ...
  for ( var i = 0; i < 361; i++ ) {
    // codx = state.planchette.pos.x + Math.round(FOVEA_RADIUS * Math.cos(i  * (Math.PI / 180)));
  ...
  ctx3.drawImage(planchette, state.planchette.pos.x - PLANCHETTE_WIDTH/2, state.planchette.pos.y - PLANCHETTE_HEIGHT/2);
